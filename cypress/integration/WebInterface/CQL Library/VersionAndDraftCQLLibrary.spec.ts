...
describe('Add Version and Draft to CQL Library', () => {
   ...
   it.only('User cannot create a draft of a draft that already exists, while the version is still open', () => {
   ...
   it('Draft of a draft can be created, after a version has been finalized', () =>{
