...
let measureName = 'ProportionNonPatient' + Date.now()
let CqlLibraryName = 'ProportionNonPatient' + Date.now()
...
describe.skip('Measure Creation and Testing: Proportion Non-Patient Based', () => {
    ...
    it('End to End Proportion Non-Patient Based, Pass Result', () => {

        //Click on Edit Button
        MeasuresPage.clickEditforCreatedMeasure()
        cy.get(EditMeasurePage.cqlEditorTab).click()

        cy.readFile('cypress/fixtures/TEST.txt').should('exist').then((fileContents) => {
